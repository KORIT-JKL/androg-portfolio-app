  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* 문의페이지 Route */}
        <Route path="/page/notice" element={<AuthRoute path="/page/notice" element={<Notice />} />} />
        <Route path="/page/customer" element={<AuthRoute path="/page/customer" element={<CustomerSupport />} />} />

        {/* url 수정필요 */}
        <Route path="/page/customer/inquiry" element={<InquiryResponse />} />

        <Route path="/page/shipping" element={<AuthRoute path="/page/shipping" element={<Shipping />} />} />
        <Route path="/page/sizeguide" element={<AuthRoute path="/page/sizeguide" element={<SizeGuide />} />} />
        <Route path="/page/legal" element={<AuthRoute path="/page/legal" element={<Legal />} />} />
        {/* 마이페이지 Route */}
        ...
        <Route
          ...
          element={<AuthRoute path="/auth/products/:productId/details" element={<ProductDetails />} />}
        ></Route>
        <Route
        ...
        {/* url 수정필요 */}
        <Route path="/product/payment" element={<AuthRoute path="/product/payment" element={<Payment />} />} />
