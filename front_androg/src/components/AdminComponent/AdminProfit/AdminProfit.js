...
const AdminProfit = () => {
  ...
  const getDateTotalPrice = useQuery(
    ["getDateTotalPrice"],
    async () => {
      const response = await axios.get("http://52.79.158.206/admin/rank/date", option);
      return response;
    },
    {
      onSuccess: (response) => {
  ...
  const getCountRank = useQuery(
    ["getCountRank"],
    async () => {
      const response = await axios.get("http://52.79.158.206/admin/rank/count", option);
      return response;
    },
    {
      enabled: refresh,
  ...
  const getProfitRank = useQuery(
    ["getProfitRank"],
    async () => {
      const response = await axios.get("http://52.79.158.206/admin/rank/profit", option);
      return response;
    },
    {
      enabled: refresh,
  ...
  const getUserRank = useQuery(
    ["getUserRank"],
    async () => {
      const response = await axios.get("http://52.79.158.206/admin/rank/user", option);
      return response;
    },
    {
      enabled: refresh,
