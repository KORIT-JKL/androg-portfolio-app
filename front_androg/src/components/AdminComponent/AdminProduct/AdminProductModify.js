...
const AdminProductModify = () => {
  ...
  const productDelteFunction = useMutation(
    async () => {
      ...
      const response = await axios.delete("http://52.79.158.206/admin/products/delete", option);
      return response;
    },
    {
      onSuccess: () => {
  ...
  const searchProducts = useQuery(
    ...
    async () => {
      ...
      const response = await axios.get(
        `http://52.79.158.206/admin/products/${selectCategoryId}`,
        option
      );
  ...
  const getColor = useQuery(
    ...
    async () => {
      ...
      // 전체 색상 들고오기
      const response = await axios.get("http://52.79.158.206/admin/products/colors", option);
      return response;
    },
    {
      onSuccess: (response) => {
  ...
  const modify = async () => {
    ...
    try {
      const response = await axios.put(
        "http://52.79.158.206/admin/products/modify",
