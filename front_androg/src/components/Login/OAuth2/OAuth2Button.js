...
const OAuth2Button = ({ provider, children }) => {
  const onClickHandle = (provider) => {
    if (provider === "google") {
      window.location.href = "http://52.79.158.206/oauth2/authorization/google";
    } else if (provider === "naver") {
      window.location.href = "http://52.79.158.206/oauth2/authorization/naver";
    } else if (provider === "kakao") {
      window.location.href = "http://52.79.158.206/oauth2/authorization/kakao";
    }
  };
